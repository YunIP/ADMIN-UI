...
namespace kcfinder;
?>
<script src="static/js/index.php" type="text/javascript"></script>
<script src="localize.php?lng=<?php echo $this->lang?>" type="text/javascript"></script>
<?php
...
if (file_exists("static/{$this->config['theme']}/js.php")):
?>
<script src="static/<?php echo $this->config['theme']?>/js.php" type="text/javascript"></script>
<?php
endif;
?>
