...
class browser extends uploader {
    ...
    protected function sendDefaultThumb($file=null) {
        if ($file !== null) {
            ...
            $thumb = "static/{$this->config['theme']}/img/files/big/$ext.png";
        }
        if (!isset($thumb) || !file_exists($thumb))
            $thumb = "static/{$this->config['theme']}/img/files/big/..png";
    ...
    protected function getFiles($dir) {
        ...
        foreach ($files as $file) {
            ...
            $name = basename($file);
            $ext = file::getExtension($file);
            $bigIcon = file_exists("static/{$this->config['theme']}/img/files/big/$ext.png");
            $smallIcon = file_exists("static/{$this->config['theme']}/img/files/small/$ext.png");
